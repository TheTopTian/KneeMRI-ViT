...
class ELNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_classes = kwargs.get('num_classes', 3)  # number of classes for ELNet
        self.feature_dropout = kwargs.get('feature_dropout', 0.0)
