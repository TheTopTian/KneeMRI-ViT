...
def print_stats(batch_train_losses, batch_valid_losses,
    ...
    print(f'Train losses - abnormal: {batch_train_losses[0]:.3f},',
          ...
          f'\nTest losses - abnormal: {batch_test_losses[0]:.3f},',
          f'acl: {batch_test_losses[1]:.3f},',
          f'meniscus: {batch_test_losses[2]:.3f}',
...
def save_checkpoint(Fold_num, epoch, plane, diagnosis, model, optimizer, out_dir):
